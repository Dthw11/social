...
class FirebaseProfileRepo implements ProfileRepo {
  ...
  @override
  Future<ProfileUser?> fechUserProfile(String uid) async {
    try {
  ...
  Future<void> updateProfile(ProfileUser updateProfile) async {
    try {
      ...
      await firebaseFirestore.collection('user').doc(updateProfile.uid).update({
    ...
    try {
      ...
      if (currentUserDoc.exists && targetUserDoc.exists) {
        ...
        if (currentUserData != null && targetUserData != null) {
          ...
          // check id the current user is already following the target user
